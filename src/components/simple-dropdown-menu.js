...
export class SimpleDropdownMenu extends HTMLElement {
    ...
    this.attachShadow({ mode: "open" }).innerHTML = /* HTML */ `
      <style>
        ...
        .menu-list > li > a:hover {
          ...
          animation: background-opacity-pulse 2s linear 0s infinite alternate
            both;
        }
  ...
  connectedCallback() {
    ...
    this.shadowRoot
      ...
      .addEventListener("mouseout", this.mouseHandler);
  }
  ...
  disconnectedCallback() {
    ...
    this.shadowRoot
      .querySelector("ul.menu-list")
      .removeEventListener("mouseout", this.mouseHandler);
  }
}
