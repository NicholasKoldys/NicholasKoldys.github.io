...
export class DevPortfolioLanding extends HTMLElement {
  constructor() {
    super();
    this.attachShadow({ mode: "open" }).innerHTML = /* HTML */ `
      ...
      <div class="container">
        ...
        <p class="summary">
          ${content.landing.summary}<a href="${content.landing.morePath}"
            >${content.landing.more}</a
          >
        </p>
        <div></div>
      </div>
...
customElements.define("dev-portfolio-landing", DevPortfolioLanding);
