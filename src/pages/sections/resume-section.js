...
export class InteractiveResume extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const projectsArr = content.resume.projectsArr.map((obj) => {
      return /* HTML */ `<li>
        <a class="breathing" href="${obj.repo}">${obj.title}</a>
      </li>`;
    });
    ...
    this.shadowRoot.innerHTML = /* HTML */ `
      <style>
        ...
        a.breathing:hover {
          text-decoration: underline var(--text-primary) 0.5ex;
        ...
        h1#resume-title {
          display: block;
          text-align: center;
          font-size: clamp(0.5ch, 15ch, 10vh);
          line-height: clamp(0.5ch, 12ch, 8vh);
        ...
        h1#resume-title::first-line {
          ...
          text-shadow: -0.1ch 0.1ch var(--section-shadow);
        }
        ...
        #resume-contact {
          ...
          #contact-links {
            ...
            a {
              ...
              font-weight: bolder;
              font-size: clamp(0.5ch, 6ch, 4dvw);
              line-height: clamp(0.5ex, 6ex, 4vh);
          ...
          .messageEmail {
            svg {
              fill: #8711d0;
              max-height: clamp(0.5ex, 5ex, 20vh);
            }
          }
          .messageEmail:hover {
            svg {
        ...
        .topic {
          ...
          li.big {
            ...
            font-size: clamp(0.5ch, 2ch, 2dvw);
            line-height: clamp(0.5ex, 2ex, 2vh);
        ...
        @keyframes breathing-underline-pulse-text {
          ...
          33% {
            text-decoration: underline var(--react-dark) 0.5ex;
          }
          66% {
            text-decoration: underline var(--react-dark) 0.5ex;
          }
      ...
      <article id="resume">
        ...
        <div id="resume-contact" class="part">
          ...
          <div id="contact-links">
            <a
              class="linkedInFull breathing"
              target="_blank"
              href="${content.resume.experiencePath}"
              aria-label="${content.resume.experienceAria}"
            >
              ${lnFull}
            </a>
            |
            <a
              class="gitHubFull breathing"
              target="_blank"
              href="${content.resume.projectsPath}"
              aria-label="${content.resume.projectseAria}"
            >
              ${gitFull}
            </a>
            |
            <a
              class="messageEmail breathing"
              href="#section-3"
              aria-label="${content.resume.messagePath}"
        ...
        <div class="topic">
          <div class="experience">
            ...
            <div id="resume-back" class="part">
              ...
              <ul>
                <li>
                  <h3>${content.resume.school1}</h3>
                  <pre>${content.resume.degree1}</pre>
                </li>
                <li>
                  <h3>${content.resume.school2}</h3>
                  <pre>${content.resume.degree2}</pre>
                </li>
              </ul>
            </div>
          ...
          <div id="resume-about" class="about">
            ...
            <div id="resume-cert" class="part">
              ...
              <ul>
                ...
                <li>
                  <a href="${content.resume.experiencePath}" class="breathing"
                    >${content.resume.certsInfo}</a
                  >
                </li>
              </ul>
            </div>
            ...
            <div id="resume-projects" class="part">
              ...
              <ul>
                ...
                <li class="big">
                  <a
                    class="gitHubSmall breathing"
                    href="${content.resume.projectsPath}"
                    >${gitSmall}${content.resume.projectsInfo}</a
                  >
                </li>
              </ul>
            </div>
