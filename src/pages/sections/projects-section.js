    ...
    connectedCallback() {
        this.shadowRoot.innerHTML= /* HTML */`
            ...
            <project-card data-main-image-url="${matsoMain}" data-image-urls='["${matso1}", "${matso4}"]'>
                ...
                <p slot="description">${ content.projects.matso.description }</p>
                <a slot="more" href="${ content.projects.matso.gitPath }" >Learn More >></a>
            </project-card>
            
            <project-card data-main-image-url="${noteApp}" data-image-urls='[]'>
                <h3 slot="title">${ content.projects.collegeApp.title }</h3>
                <p slot="description">${ content.projects.collegeApp.description }</p>
                <a slot="more" href="${ content.projects.collegeApp.gitPath }" >Learn More >></a>
            </project-card>
            ...
            <project-card data-main-image-url="${schedulerMain}" data-image-urls='["${scheduler2}", "${scheduler3}"]'>
                ...
                <p slot="description">${ content.projects.scheduler.description }</p>
                <a slot="more" href="${ content.projects.scheduler.gitPath } " >Learn More >></a>
            </project-card>
            ...
            <project-card data-main-image-url="${inventory1}" data-image-urls='[]'>
                ...
                <p slot="description">${ content.projects.inventoryManagementSystem.description }</p>
                <a slot="more" href="${ content.projects.inventoryManagementSystem.gitPath } " >Learn More >></a>
            </project-card>
        `;
    }
}
